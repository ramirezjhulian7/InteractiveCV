    ...
    return (
        <div style={{
            ...
            <div onClick={(e) => e.stopPropagation()} style={{
                ...
                textAlign: 'center', padding: '28px 28px 24px',
                color: '#fff',
            }}>
                {/* Avatar */}
                ...
                <div style={{ textAlign: 'left', fontSize: 12, lineHeight: 2 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        <span style={{ color: '#999' }}>macOS</span>
                        <span style={{ color: '#ccc' }}>JhulianOS 1.0</span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        <span style={{ color: '#999' }}>Location</span>
                        <span style={{ color: '#ccc' }}>{profile.location}</span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        <span style={{ color: '#999' }}>Specialties</span>
                        <span style={{ color: '#ccc' }}>Angular · .NET · AI</span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        <span style={{ color: '#999' }}>Languages</span>
                        <span style={{ color: '#ccc' }}>{profile.languages.map(l => l.name).join(', ')}</span>
                    </div>
                </div>
                ...
                <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
                    <a href={profile.linkedin} target="_blank" rel="noopener noreferrer" style={{
                        padding: '6px 16px', borderRadius: 6, background: 'rgba(59,130,246,0.15)',
                        color: '#60a5fa', fontSize: 12, fontWeight: 600, textDecoration: 'none',
                        border: '1px solid rgba(59,130,246,0.3)', transition: 'background 0.15s',
                    }}>LinkedIn</a>
                    <a href={`mailto:${profile.email}`} style={{
                        padding: '6px 16px', borderRadius: 6, background: 'rgba(255,255,255,0.06)',
                        color: '#ccc', fontSize: 12, fontWeight: 600, textDecoration: 'none',
